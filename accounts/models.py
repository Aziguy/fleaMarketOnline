...
class User(AbstractBaseUser):
    ...
    username = models.CharField(max_length=50, unique=True, help_text="The username of that user.")
    email = models.EmailField(max_length=100, unique=True, help_text="Email address of the user.")
    phone_number = models.CharField(max_length=12, blank=True, help_text="The phone number of the user.")
