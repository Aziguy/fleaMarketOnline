    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "firstname",
                    models.CharField(help_text="Firstname of the user.", max_length=50),
                ),
                (
                    "lastname",
                    models.CharField(help_text="Lastname of the user.", max_length=50),
                ),
                (
                    "username",
                    models.CharField(
                        help_text="The username of that user.",
                        max_length=50,
                        unique=True,
                    ),
                ),
